...
2. dob.getMonth(): Returns the month (0-11) of the date, where 0 represents January and  11 represents December.

3. dob.getDate(): Returns the day of the month (1-31) of the date.

4. dob.getDay(): Returns the day of the week (0-6) of the date, where 0 represents Sunday and  6 represents Saturday.

4. dob.getHours(): Returns the hour (0-23) of the date.

5. dob.getMinutes(): Returns the minutes (0-59) of the date.

6. dob.getSeconds(): Returns the seconds (0-59) of the date.

7. dob.getMilliseconds(): Returns the milliseconds (0-999) of the date.

8. dob.getTime(): Returns the timestamp as the number of milliseconds since January 1, 1970 (Unix Epoch).

9. dob.setDate(day): Sets the day of the month (1-31) of the date.

10. dob.setMonth(month[, day]): Sets the month (0-11) and optionally the day of the month (1-31) of the date.

11. dob.setFullYear(year[, month[, day]]): Sets the year (4 digits), month (0-11), and optionally the day of the month (1-31) of the date.

12. dob.setHours(hour[, min[, sec[, ms]]]): Sets the hour (0-23), minutes (0-59), seconds (0-59), and optionally milliseconds (0-999) of the date.

13. dob.setMinutes(min[, sec[, ms]]]): Sets the minutes (0-59), seconds (0-59), and optionally milliseconds (0-999) of the date.

14. dob.setSeconds(sec[, ms]): Sets the seconds (0-59) and optionally milliseconds (0-999) of the date.

15. dob.setMilliseconds(ms): Sets the milliseconds (0-999) of the date.

16. dob.setTime(time): Sets the timestamp of the date as the number of milliseconds since January 1, 1970 (Unix Epoch).

17. dob.toString(): Returns a string representation of the date.

18. dob.toISOString(): Returns a string representation of the date in ISO 8601  format.

19. dob.toUTCString(): Returns a string representation of the date in UTC time.
